...
class VideoPlayer
{
    ...
    async initialize(canvas, container)
    {
        ...
        for (const screenEntity of screens)
        {
            ...
            console.log(videoElement.geometries);
        ...
        this.sdk.notifier.on('OnCamerasUpdated', async cameras =>
        {
            ...
            {
                console.log(videoElement.isVisible());
                const isVisible = true;//videoElement.isVisible();
                let isInside    = true;
    ...
    createVideoElement(id, globalTransform)
    {
        ...
        const pixelToUnitScale = 1500; // 100 pixel = 1 unit

        const iframeURL = [ 'https://www.youtube.com/embed/e2h_PY9xk5w?si=37WudMffc9nDJB1f', '?rel=0', '&autoplay=1' ].join('');
//https://www.youtube.com/embed/e2h_PY9xk5w?si=37WudMffc9nDJB1f
